...
const styles = StyleSheet.create({ safe:{flex:1,backgroundColor:colors.atmosphere},content:{padding:28,gap:10},label:{fontFamily:fonts.systemMedium,color:colors.textSubdued,fontSize:13,marginTop:12},input:{minHeight:52,borderWidth:1,borderColor:colors.border,borderRadius:12,paddingHorizontal:14,color:colors.textPrimary,backgroundColor:colors.surface,fontFamily:fonts.system,fontSize:16},email:{minHeight:52,paddingVertical:16,color:colors.textPrimary,fontFamily:fonts.system,fontSize:16},save:{marginTop:20,minHeight:52,borderRadius:26,alignItems:'center',justifyContent:'center',backgroundColor:'#5B625F'},saveText:{fontFamily:fonts.systemSemibold,color:colors.textPrimary,fontSize:16},notice:{fontFamily:fonts.system,color:colors.textSubdued,textAlign:'center',marginTop:8} });
