export const en = {
  app: { name: 'Pebble', loading: 'Loading Pebble', retry: 'Try again', settings: 'Settings', notConfigured: 'Pebble is not configured on this device.' },
  auth: {
    ...
    existingAccount: 'I already have access', createError: 'Could not create profile.', signInError: 'Could not sign in.',
  },
  pairing: {
  ...
  shore: { quiet: 'A quiet shore.', shared: 'Shared shore', incoming: 'Incoming pebble', sent: 'Sent pebble', send: 'Send a pebble', loading: 'Loading shore', closed: 'This shore is closed.', sendError: 'Could not send pebble.', touchError: 'Could not touch pebble.', loadError: 'Could not load shore.' },
  settings: {
